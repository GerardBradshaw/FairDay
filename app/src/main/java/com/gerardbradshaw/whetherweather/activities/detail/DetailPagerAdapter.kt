    ...
    RecyclerView.Adapter<DetailPagerAdapter.DetailViewHolder>()
{
  ...
  fun addNewLocation(locationEntity: LocationEntity) {
    if (locationEntityList.contains(locationEntity)) {
      Log.e(TAG, "addNewLocation: ERROR: ${locationEntity.locality} cannot be duplicated.")
      return
    }
    ...
    Log.i(TAG, "addNewLocation: ${locationEntity.locality} added.")
  }
  ...
  fun updateWeatherData(
    ...
    if (locationIndex == -1) {
      Log.e(TAG, "updateWeatherData: ERROR: ${locationEntity.locality} could not be found.")
      return
    }
